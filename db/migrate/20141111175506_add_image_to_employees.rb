...
class AddImageToEmployees < ActiveRecord::Migration
  ...
  def self.down
    ...
    remove_column :employees, :image_file_name
    remove_column :employees, :image_content_type
    remove_column :employees, :image_file_size
    remove_column :employees, :image_updated_at
  end
end
